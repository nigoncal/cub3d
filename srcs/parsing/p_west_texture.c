...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/18 17:06:04 by sylducam          #+#    #+#             */
/*   Updated: 2021/05/18 17:12:33 by sylducam         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * verifie d'abord que l'identifiant n'a pas deja ete rencontre avec le booleen setup->west
 ...
 * si tout s'est bien passe, le path est stocke dans setup->west_texture_path et setup->west est mis a true
*/
...
static int	right_file(t_setup *setup)
{
	...
	fd = 0;
	if (ft_strcmp(setup->elements[0], "WE") != 0)
		return (-1);
