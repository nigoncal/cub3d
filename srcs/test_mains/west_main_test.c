...
int main()
{
	...
	dprintf(1, "--- test 2 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE    ../textures/grass.xpm    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	dprintf(1, "--- test 3 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE    38     xpm    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	dprintf(1, "--- test 4 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE   38   ../textures/stone.png   ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	dprintf(1, "--- test 5 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE   ../textures/stone.png   ../textures/grass.xpm    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	dprintf(1, "--- test 6 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE    ../textures/file.txt    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	...
	dprintf(1, "--- test 8 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WE    ../textures.xpm    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
	dprintf(1, "--- test 9 ---\n");
	ft_bzero(&cub_sets, sizeof(cub_sets));
	ret = west_texture("WErdine    ../textures/grass.xpm    ", &cub_sets);
	dprintf(1, "ret = %d\n", ret);
	dprintf(1, "WE = %d\n", cub_sets.WE);
	dprintf(1, "west_texture_fd = %d\n", cub_sets.west_fd);
	dprintf(1, "west_texture_path = |%s|\n", cub_sets.west_texture_path);
